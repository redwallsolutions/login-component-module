...
var flipFrontAnimationProps = css(_templateObject6(), flipFront);
var flipFrontAnimationPropsReverse = css(_templateObject7(), flipFrontReverse);
var flipBack = keyframes(_templateObject8());
var flipBackReverse = keyframes(_templateObject9());
...
export var Box = styled.div(_templateObject12(), function (props) {
  ...
  return props.isFirstTime && !props.isBack ? comin : '';
}, function (props) {
  return !props.isFirstTime && props.isBack && flipFrontAnimationProps;
}, function (props) {
  return !props.isFirstTime && !props.isBack && flipFrontAnimationPropsReverse;
}, function (props) {
  return props.isFirstTime && props.isBack && flipFrontAnimationProps;
});
